            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left">
							<div class="logo-name">
									 <a href="{{URL::to('/dashboard')}}"> <h1>Admin</h1> 
									...
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">	
												<span class="prfil-img"><img src="backend/images/admin.jpg" alt="" height="50px" width="40px">
												</span> 
												<div class="user-name">
													<p class="user-name-base"><?php
										...
										<ul class="dropdown-menu drp-mnu">
											...
											<li> <a href="{{URL::to('/logout')}}"><i class="fa fa-sign-out"></i>Đăng xuât</a> </li>
										</ul>
									</li>
								</ul>
							</div>
...
<div class="copyrights">
	 <p>© 2019 Ecommerce MacbookShop. All Rights Reserved </a> </p>
</div>	
		      ...
		      <ul id="menu" >
		        ...
		        <li id="menu-comunicacao" ><a href="#"><i class="fa fa-book nav_icon"></i><span>Danh mục sản phẩm</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          <ul id="menu-comunicacao-sub" >
		            ...
		            <li id="menu-arquivos" ><a href="{{URL::to('/all-category-product')}}">Liệt kê</a></li>
