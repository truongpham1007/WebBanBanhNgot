...
<div class="inner-header">
		<div class="container">
			<div class="pull-left">
				@foreach($cate_name as  $catename => $name)
				<h6 class="inner-title"  style="color: blue">{{$name->category_name}}</h6>
				@endforeach
			</div>
			<div class="pull-right">
				<div class="beta-breadcrumb font-large">
					<a href="{{URL::to('/home')}}">Trang chủ</a> / <span>Sản phẩm</span>
				</div>
			</div>
				...
				<div class="row">
					...
					<div class="col-sm-9">
						<div class="beta-products-list">
							...
							<div class="row">
								@foreach($category_id  as $keyid => $product)
								<div class="col-sm-4">
